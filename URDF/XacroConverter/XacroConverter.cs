...
public class XacroConverter
{
    ...
    public void Convert()
    {
        ...
        var robot = new XacroMacroContext(doc.DocumentElement, Path.GetFullPath(Path.GetDirectoryName(Path.GetDirectoryName(inputFilePath))), new(), new(), new());
        robot.ExpandMacros();
        ...
        string outputDirectory = Path.GetDirectoryName(outputFilePath) ?? throw new DirectoryNotFoundException("Output directory not found.");
